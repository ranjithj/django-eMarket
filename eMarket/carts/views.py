...
class CartView(SingleObjectMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if item_id:
            ...
            if delete_item:
                flash_message = "Successfully deleted from the cart"
                cart_item.delete()
            else:
                if not created:
        ...
        if request.is_ajax():
            ...
            data = {
                "deleted": delete_item, "item_added": item_added, "line_total": total, "subtotal":subtotal, "flash_message": flash_message, "total_items":total_items, "tax_total": tax_total, "cart_total": cart_total
            }
...
class CheckoutView(CartOrderMixin, FormMixin, DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            print(request.session["user_checkout_id"])
